package com.otiswolf.tutorialmod.block;

import com.otiswolf.tutorialmod.TutorialMod;
import com.otiswolf.tutorialmod.item.ModItems;
...
public class ModBlocks {
    public static final DeferredRegister<Block> BLOCKS = DeferredRegister
            .create(ForgeRegistries.BLOCKS, TutorialMod.MOD_ID);
